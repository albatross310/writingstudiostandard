...
export default function Standard() {
  ...
  return (
    <main>
      ...
      <section><div className="container container--prose"><p className="section-label">Principles</p><h2>Six commitments</h2><hr className="divider" /><div className="trio-grid">
