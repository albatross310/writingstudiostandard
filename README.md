...
When the specification changes, download the Markdown from the public page and confirm it identifies the current document model and capability status.
